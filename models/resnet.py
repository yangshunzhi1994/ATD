...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=10):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(1) # nn.AvgPool2d(8)
...
def build_resnet_backbone(depth=20, num_classes = 100):
    if depth == 20:
...
def build_resnetx4_backbone(depth=20, num_classes = 100):
    if depth == 8:
